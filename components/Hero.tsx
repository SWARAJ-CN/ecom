...
const Hero = () => {
  return (
    <div className="w-full max-w-7xl mx-auto   py-5 overflow-x-clip md:overflow-visible">
      <div className="mt-10 md:mt-12 rounded-2xl bg-linear-to-r from-[#F4E8F3] via-[#F3EFF6] to-[#EEE0F9] grid grid-cols-1 md:grid-cols-[4fr_2fr] min-h-80 md:h-72">
