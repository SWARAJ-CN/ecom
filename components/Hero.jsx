...
const Hero = () => {
  return (
    <div className="max-w-7xl w-[calc(100%-2rem)] mx-auto mt-10 md:mt-25 rounded-2xl bg-linear-to-r from-[#F4E8F3] via-[#F3EFF6] to-[#EEE0F9] grid grid-cols-1 md:grid-cols-[4fr_2fr] min-h-80 md:h-72 ">
      <div className="w-full flex flex-col gap-3 px-6 sm:px-10 md:px-12 lg:px-15 py-8 md:py-0 justify-center items-start">
        <p className="font-extrabold text-2xl sm:text-3xl lg:text-[34px] text-[#3A4980] leading-tight w-full md:w-[85%] lg:w-3/4">
